...
const reply = (teks) => {
    ZimBotInc.sendMessage(m.chat, {text: teks, contextInfo: {"externalAdReply": {title: "𝕴𝖞𝖆𝖓𝕸𝖉",mediaType: 3, renderLargerThumbnail: false, showAdAttribution: true, detectLinks: true,body: "𝕴𝖞𝖆𝖓𝕸𝖉", thumbnail: fs.readFileSync('./drips.jpg'),sourceUrl: ("https://youtu.be/Y5shyYOUIuw")}}})
}
const replay = (teks) => {
    ZimBotInc.sendMessage(m.chat, {text: teks, contextInfo: {"externalAdReply": {title: "𝕴𝖞𝖆𝖓𝕸𝖉",mediaType: 3, renderLargerThumbnail: false, showAdAttribution: true, body: "𝕴𝖞𝖆𝖓𝕸𝖉", thumbnail: fs.readFileSync('./drips.jpg'),sourceUrl: ("https://youtu.be/Y5shyYOUIuw")}}})
}
...
body: "GIVE IT A STAR",
mediaType: "VIDEO",
mediaUrl: `https://githb.com/IyanXd`,
description: 'IyanXd',
previewType: "PHOTO",
...
hydratedFooterText: `ʀᴘɢ ɢᴀᴍᴇ ʙʏ ɪʏᴀɴᴍᴅ`,
hydratedButtons:  [{        
    "urlButton": {
      "displayText": "My Github",
      "url": "https://github.com/IyanXd"
    }
}, {
quickReplyButton: {
...
❲ *_ʀᴘɢ ɢᴀᴍᴇ_* ❳`
  ...
  .catch ((err) => reply(err))
          ...
          const emote = (satu, dua) => {
            ...
            const buttonMessage = {image: {url: emoji.images[dua].url},caption: "𝕴𝖞𝖆𝖓𝕸𝖉",footerText: 'Loading...',buttons: buttons,headerType: 4}
...
setTimeout(function(){
  ZimBotInc.sendMessage(ZimBotInc.user.id, {text: `*IYAN BOT INC ANNOUNCEMENT:* *FOLLOW IG TO yanxd81*\n\n*GITHUB:* https://github.com/IyanXd\n\n*NEW FEATURES COMING SOON SO STAY TUNED*\n\n*FEEL FREE TO BRING IDEAS OF THE FEATURES ON THE TABLE*\n\n*IF YOU WANT TO CONTRUBUTE FORK THE REPO, MAKE CHANGES PUSH YOUR CHANGES TO THE ORIGIN BRANCH AND WAIT FOR YOUR PULL REQUEST TO BE VERIFIED*\n\n*Thanks for choosing iyan-bot*`,contextInfo: { externalAdReply:{title:"𝕴𝖞𝖆𝖓𝕸𝖉",body:"𝕴𝖞𝖆𝖓𝕸𝖉",showAdAttribution: true,mediaType:2,thumbnail: fs.readFileSync(`./drips.jpg`) ,mediaUrl:`https://youtu.be/Y5shyYOUIuw`, sourceUrl: `https://youtu.be/Y5shyYOUIuw` }}}, {quoted: m})
...
switch(command) {
  case 'quest':
    ...
    ZimBotInc.sendList(m.chat, `Hi Chomie *${pushname}*`, `Please Select Below`, "CLICK", "ʀᴘɢ ɢᴀᴍᴇ ʙʏ ʏᴀɴʙᴏᴛ ", sectionnya, { quoted: m})
    break
    case 'slime':
    case 'killslime':
...
var button = [
        ...
        ZimBotInc.sendMessage(from, { caption: hg, location: { jpegThumbnail: cing }, templateButtons: button, footer: `ʀᴘɢ ɢᴀᴍᴇ ʙʏ ʏᴀɴʙᴏᴛ`, mentions: [sender] })
...
var button = [
        ...
        var hg = `「 DEATH 」\n\n *┊ Place*  ${ad}\n ┊ *MONEY :* $${money}\n ┊ *EXP :* ${adven}Xp`
        ZimBotInc.sendMessage(from, { caption: hg, location: { jpegThumbnail: hasm }, templateButtons: button, footer: `ʀᴘɢ ɢᴀᴍᴇ ʙʏ ʏᴀɴʙᴏᴛ`, mentions: [sender] })
        .catch ((err) => reply(mess.error))
}, 7000)
setTimeout( () => {
 ...
 */
 ...
 case 'sc': case 'script': case 'donate': case 'donasi': case 'donate': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
  ...
  teks = `
  *IYAN-BOT-V4*\n\n*TikTok:* https://tiktok.com/@afa.banh\n*Github:* https://github.com/IyanXd\n\n*Donate:* https://saweria.co/IyanXDBotZ\n*Script Base:* https://github.com/DikaArdnt`
  let buttons = [
  ...
  mediaType:1,
  mediaUrl: 'https://youtu.be/Y5shyYOUIuw',
  sourceUrl: "https://youtu.be/Y5shyYOUIuw"
  }}
  }
  ZimBotInc.sendMessage(m.chat, buttonMessage, { quoted: m })
  }
...
reply(mess.wait)
 ...
 if(!args[0]) throw 'link github  EXAMPLE: https://github.com/IyanXd/'
if (!regex1.test(args[0])) throw 'link!'
 ...
 case 'truth':
        ...
        thumbnail: fs.readFileSync(`./drips.jpg`) ,
        mediaUrl:`https://youtu.be/Y5shyYOUIuw`, 
        sourceUrl: `https://youtu.be/Y5shyYOUIuw` }}}, {quoted: m})
break
case 'ghsearch': 
       case 'githubsearch': 
       case 'searchgithub':
...
urlButton: {
displayText: 'Follow',
url: 'https://instagram.com/yanxd81'
}
}, {
urlButton: {
displayText: 'Github',
...
case 'bc2': case 'bcloc': {
if (!isCreator) throw mess.owner
if (!text) throw `*Type some text*\n\nExample : ${prefix + command} yan|hi5`
let anu = await store.chats.all().map(v => v.id)
...
let anu = await store.chats.all().map(v => v.id)
let ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "6289523258649-1604595598@g.us"}, "message": {orderMessage: {itemCount: 2022,status: 200, thumbnail: fs.readFileSync('./drips.jpg'), surface: 200, message: `YAN-BOT-INC`, orderTitle: '𝕴𝖞𝖆𝖓𝕸𝖉', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
...
// https://hardianto.xyz/api/beta/hacker2?apikey=hardianto&pp=https://i.ibb.co/1s8T3sY/48f7ce63c7aa.jpg
  ...
  ZimBotInc.sendMessage(m.chat, { image: dri,caption:'YAN-BOT-V4' }, { quoted: m})
...
break// https://hardianto.xyz/api/beta/hacker2?apikey=hardianto&pp=https://i.ibb.co/1s8T3sY/48f7ce63c7aa.jpg
  ...
  dri = await getBuffer(dripa)
  ZimBotInc.sendMessage(m.chat, { image: dri,caption:'𝕴𝖞𝖆𝖓𝕸𝖉' }, { quoted: m})
...
let buttons = [{
 urlButton: {
  displayText: 'Report',
  url: 'https://wa.me/62895323413434?text=hello+bro+i+found+a+bug+in+your+bot'
 }
  }, {
 quickReplyButton: {
  displayText: 'Start',
...
{ buttonId: 'stop', buttonText: { displayText: 'Stop' }, type: 1 }
  ...
  await ZimBotInc.sendButtonText(m.chat, buttons, `_You Are Still In Anonymous Session, 𝕴𝖞𝖆𝖓𝕸𝖉 To Terminate Your Anonymous Session_`, ZimBotInc.user.name, m)
  throw false
   }
...
{ buttonId: 'keluar', buttonText: { displayText: 'STOP' }, type: 1 }
 ...
 case 'attp': {
  reply(mess.wait)
  if (!text) throw `*Example : ${prefix + command} yan hi*`
  await ZimBotInc.sendMedia(m.chat, `https://hardianto.xyz/api/maker/attp?text=${text}&apikey=hardianto`,'𝕴𝖞𝖆𝖓𝕸𝖉', 'IyanGamteng', m, {asSticker: true}).catch((err) => m.reply('*error while sending sticker*'))
            }
            break
/*case 'ripmaker':
  reply(mess.wait)
 ...
 case 'self': {
   ...
   reply('𝗜𝘆𝗮𝗻 𝗯𝗼𝘁 𝗻𝗼𝘄 𝘄𝗼𝗿𝗸𝗶𝗻𝗴 𝗮𝘀 𝗽𝗿𝗶𝘃𝗮𝘁𝗲')
 }
 break
...
break
case 'tes': case 'test': case 'alive': case 'bot': case 'robot': case 'yanbot': case 'yan':{
...
huso = await getBuffer(picak+'IYAN BOT IS ALIVE')
...
break
  ...
  ZimBotInc.sendMessage(`62895323413434@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
reply(`*Successfully reported to the owner\n\nPlease make sure the bug is valid, if you play with this, use this feature again and again for no reason, you will be banned for using yan bot*`)
  }
break 
case 'listmenu':             
  let sections = []   
...
%readmore` 
    ...
    const buttonsDefault = [{ urlButton: { displayText: `Follow`, url : `https://instagram.com/yanxd81` } }, { urlButton: { displayText: `Github`, url : `https://github.com/IyanXd` } },
    {					
      quickReplyButton: {
      displayText: 'Speed',
      id: 'ping'
